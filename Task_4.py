# Task 4. 4.Задана натуральная степень k. Сформировать случайным образом список 
...
with open('C:\\Users\Надюша\Desktop\Phyton_Homework4\Polinomial_task4.txt', 'a') as data:
